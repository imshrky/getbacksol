...
export const FAQ_ITEMS = [
  ...
  {
    q: "Why a 30% fee?",
    a: "The service fee covers RPC infrastructure and keeps the tool running. It's calculated on the amount reclaimed and sent in the same atomic transaction, so you always see the exact net amount before confirming.",
  },
  {
